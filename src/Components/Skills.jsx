      ...
      <div className="flex flex-row flex-wrap justify-center items-center">
        {Skills.map((skill, idx) => (
          <div
            data-aos="flip-right"
            key={idx}
            className="w-20 h-20 hover:w-24 hover:h-24 px-2 py-2 m-4 hover:my-2 hover:mx-2 duration-150 ease-in-out border bg-cyan-900 bg-opacity-20 text-cyan-500 hover:text-cyan-300 border-cyan-600 hover:border-cyan-400 rounded-md"
          >
