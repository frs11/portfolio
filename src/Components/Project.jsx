  ...
  return (
    <div className="bg-gradient-to-tr from-slate-900 to-slate-600 rounded-lg">
      <div className="relative">
        <p className="flex absolute rounded-t-lg h-full w-full opacity-0 hover:opacity-100 bg-black bg-opacity-60  justify-center items-center text-white duration-100 ease-in-out">
